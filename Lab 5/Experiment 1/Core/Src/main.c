...
int main(void)
{
  ...
  Task2_UARTSendHandle = osThreadNew(StartTask03, NULL, &Task2_UARTSend_attributes);

  /* creation of Task3_UARTRecei */
  Task3_UARTReceiHandle = osThreadNew(StartTask04, NULL, &Task3_UARTRecei_attributes);
